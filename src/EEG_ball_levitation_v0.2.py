...
# Thomas Vikström, 2025-11-11 23:22
# Adds probability smoothing and configurable stride. Fully EI-compatible log10 scaling.
...
STABILITY_WINDOWS = 5          # number of last decisions to require stable target
SMOOTH_WINDOWS = 7             # number of last probabilities to average
USE_MEDIAN_SMOOTH = False       # True=median smoothing, False=mean smoothing
